  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = r0.z * r0.w;
  r0.x = r0.z * 10 + r0.x;
  r1.xyzw = v5.zwzw * float4(20,20,20,20) + float4(-0.0009765625,0,0.0009765625,0);
  r2.xyzw = texRipple.SampleBias(_texRipple_s, r1.xy, -1).xyzw;
  r1.xyzw = texRipple.SampleBias(_texRipple_s, r1.zw, -1).xyzw;
  r0.z = r1.w * 2 + -1;
  r1.x = r2.w * 2 + -1;
  r0.z = -r1.x + r0.z;
  r0.z = r0.z * r0.w;
  ...
  r0.x = r0.x * r0.w;
  r0.x = r0.x * 10 + r0.y;
  r2.xyzw = v5.zwzw * float4(20,20,20,20) + float4(0,-0.0009765625,0,0.0009765625);
  r3.xyzw = texRipple.SampleBias(_texRipple_s, r2.xy, -1).xyzw;
  r2.xyzw = texRipple.SampleBias(_texRipple_s, r2.zw, -1).xyzw;
  r0.y = r2.w * 2 + -1;
  r0.z = r3.w * 2 + -1;
  r0.y = r0.y + -r0.z;
  r0.y = r0.y * r0.w;
  ...
  r4.xyzw = texDepth.Sample(_texDepth_s, r3.zw).xyzw;
  r1.w = cbExternalViewTransform.ViewScaleAndNearFar.w + -cbExternalViewTransform.ViewScaleAndNearFar.z;
  r2.z = -r4.x * r1.w + cbExternalViewTransform.ViewScaleAndNearFar.w;
  r3.z = cbExternalViewTransform.ViewScaleAndNearFar.w * cbExternalViewTransform.ViewScaleAndNearFar.z;
  r2.z = r3.z / r2.z;
  r4.xy = saturate(r2.xy);
  r2.xy = -r3.xy + r2.xy;
  r4.xyzw = texDepth.Sample(_texDepth_s, r4.xy).xyzw;
  r1.w = -r4.x * r1.w + cbExternalViewTransform.ViewScaleAndNearFar.w;
  r1.w = r3.z / r1.w;
  r3.z = r1.w + -r2.z;
  r1.w = -v6.z + -r1.w;
  r3.w = 0.00999999978 + -v6.z;
  r3.w = cmp(r3.w >= r2.z);
  r3.w = r3.w ? 1.000000 : 0;
  r3.z = r3.z * r3.w + r2.z;
  r2.z = -v6.z + -r2.z;
  r2.xy = r2.xy * r3.ww + r3.xy;
  r3.xy = r2.xy * float2(2,2) + float2(-1,-1);
  r3.xy = r3.xy * r3.zz;
  r4.z = -r3.z;
  r4.xy = cbExternalViewTransform.ViewScaleAndNearFar.xy * r3.xy;
  r4.w = -r4.y;
  r3.x = dot(r4.xwz, cbExternalViewTransform.SkyFogDir.xyz);
  r3.y = dot(v6.xyz, cbExternalViewTransform.SkyFogDir.xyz);
  r3.x = r3.x + -r3.y;
  r3.x = sbWaterLook.VerticalAbsorbExtinct.w * -abs(r3.x);
  ...
  r4.xyz = r4.xyz * cbEnvironmentSettings.AmbientColorHorizon.xyz + r5.xyz;
  r4.xyz = -sbWaterLook.VerticalAbsorbExtinct.xyz * sbWaterLook.VerticalAbsorbExtinct.xyz + r4.xyz;
  r5.xyz = sbWaterLook.VerticalAbsorbExtinct.xyz * sbWaterLook.VerticalAbsorbExtinct.xyz;
  r3.xyz = r3.xxx * r4.xyz + r5.xyz;
  r3.xyz = -sbWaterLook.AbsorbExtinct.xyz * sbWaterLook.AbsorbExtinct.xyz + r3.xyz;
  r1.w = -abs(r2.z) + abs(r1.w);
  r1.w = r1.w * r3.w + abs(r2.z);
  ...
  r0.x = 0.5 * r0.x;
  r0.y = 1 + -r1.w;
  r0.z = saturate(-0.75 + r1.w);
  r0.x = r0.x * r0.y;
  r1.xyz = r0.xxx * r1.xyz + r2.xyz;
  r4.xyzw = texRipple.Sample(_texRipple_s, v5.zw).xyzw;
  r0.x = r0.z * 16 + r4.y;
  r0.y = -r0.z * 4 + 1;
  r0.z = r4.z * 2 + -1;
  r0.x = saturate(abs(r0.z) * 2 + r0.x);
  r0.x = r0.x * r0.y;
  r0.x = r0.x * r0.x;
  r0.x = r0.w * r0.x;
  r0.y = cbTimebase.SimTime.x + cbTimebase.SimTime.x;
  r0.yz = v5.wz * float2(100,100) + r0.yy;
  r2.xy = float2(3.14159274,3.14159274) + r0.zy;
  r0.yz = sin(r0.yz);
  r2.xy = cos(r2.xy);
  r3.yz = float2(25,25) * v5.zw;
  r4.zw = r2.xy * float2(0.0562499985,0.0562499985) + r3.zy;
  r4.xy = r0.yz * float2(0.0562499985,0.0562499985) + r3.yz;
  r5.xyzw = texOcclusion.Sample(_texOcclusion_s, r4.xz).wxyz;
  r4.xyzw = texOcclusion.Sample(_texOcclusion_s, r4.wy).xyzw;
  r4.x = saturate(r4.x);
  r5.x = saturate(r5.x);
  r0.y = r5.x * r4.x;
  r0.x = r0.y * r0.x;
  r0.xyz = r0.xxx * r2.www + r1.xyz;
